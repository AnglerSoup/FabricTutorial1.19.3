package angler.tutorialmod.block;

import angler.tutorialmod.TutorialMod;
import angler.tutorialmod.item.ModItemGroup;
import angler.tutorialmod.world.tree.RedMapleSaplingGenerator;
...
public class ModBlocks {
    ...
    public static final Block RED_MAPLE_PLANKS = registerBlock("red_maple_planks",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.OAK_PLANKS).strength(4.0f).requiresTool()), ModItemGroup.CITRINE);
