...
public class ModItems {
    ...
    public static final Item ROBERT = registerItem("robert",
            new Item(new FabricItemSettings()));
    ...
    public static void addItemsToItemGroup() {
        ...
        addToItemGroup(ModItemGroup.CITRINE, ROBERT);

        addToItemGroup(ItemGroups.COMBAT, ROBERT);
    ...
    public static void registerModItems() {
        TutorialMod.LOGGER.info("Registering Mod Ideas for " + TutorialMod.MOD_ID);
